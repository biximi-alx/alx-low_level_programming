 ...
 * @n1: first numner to added                                                                              
 * @n2: second number to be added                                                                          
 * @r: store result                                                                                        
 * @size_r: size of buffer                                                                                 
 * Returns: returns pointer to result                                                                      
 */                                                                                                        
 ...
 * @n1: the string containig the first number to be added
 * @n2: The string containg the second number to be added
